...
class Level:
	...
	"""Classe permettant de créer un level"""
	...
	def generer(self):
		"""Méthode permettant de générer le level en fonction du fichier.
		...
		with open(self.fichier, "r") as fichier:
			...
			for ligne in fichier:
				...
				#On ajoute la ligne à la liste du level
	...
	def afficher(self, fenetre):
		"""Méthode permettant d'afficher le level en fonction 
